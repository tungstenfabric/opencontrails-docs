# -*- coding: utf-8 -*-
#
# vnc_api documentation build configuration file, created by
...
project = u'vnc_api'
copyright = u'2013, Juniper Networks Inc.'
...
latex_documents = [
  ('index', 'vnc_api.tex', u'vnc\\_api Documentation',
...
man_pages = [
    ('index', 'vnc_api', u'vnc_api Documentation',
...
texinfo_documents = [
  ('index', 'vnc_api', u'vnc_api Documentation',
   u'Juniper Networks Inc.', 'vnc_api', 'One line description of project.',
   'Miscellaneous'),
]
